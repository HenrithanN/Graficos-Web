export const graficoDeArea = () =>{
    ...
    const opcoes = {
        isStacked:true,
        title:'Grafico de Area - Quantidade de Novos Usuarios nas Contas',
        titleTextStyle:{
            color:'#5e5851',
            fontSize:20,
            fontType:'Arial'
    ...
    const grafico = new google.visualization.AreaChart(document.querySelector('#grafico-area'));
